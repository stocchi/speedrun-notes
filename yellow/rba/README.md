...
- TID Manip:
	...
	- _gfskip_intro0_title_newgame: 0xC5E6 (50662)
...
- Bike to jack tile and turn to face left, flash TMTRAINER
 - moving left one tile is fine
- Ujack and pick up HP Up (skip jingle if not slow)
...
- Use 6F, unjack, bike to Pokemon Center and heal (left flower's row)
...
- Flash TMTRAINER, catch Jynx with Master Ball, nickname 1 char ("J")
...
## Giovanni
- Face right and [jack](https://gunnermaniac.com/pokeworld?map=45#16/17/LUUUUUUUUUUUULLLLLLUL)
- IP, BZ, IP, IP, IP
- Before exiting gym:
 - Use Max Repel
 - Pick up Revive  
...
- Face up and medicine [jack](https://gunnermaniac.com/pokeworld?map=166#13/12/LLLLL)
...
- Bike to house near Brock fan and enter/exit, jack and bike again
...
## Misty
- Use Surfboard on left side of gym to surf to Misty
- BS, BS
