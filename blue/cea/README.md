...
- Easy extended: LRRU after Pidgey
- Full extended with npcs **DU,rl,ud**
...
- 1 Potion, unless you have one (slot 2)
- 1 Burn Heal (slot 5)
...
- Deposit all Potions (slot 1 or 2)
...
* Swap the slot above options **2 up from cursor**
* with Master Ball x5 in warping **2 under HM04**
...
* Swap vtm again with WA4 in rival name **select cursor, triple input up**
...
- Swap Poke Ball x0 in x coord **2 up Soulbadge**
- with TM17 x42 in map ID **2 up**
- Swap 9F in TID2 **2 up**
- with Parlyz Heals in slot 5 **2 above Burn Heal**
- Swap 9F again with Full Restores in slot 3 **select cursor, 2 up**
...
- with HM04 in TLP2 **2 below UltraBallx0**
- Swap TM18 x42 in x coord **down->select**
- with Ice Heal x15 in width **triple input swap down**
- Toss 6 TM18s
- Flash map (close then open the start menu)
- Swap the TM18s back with Ice Heal x15 **select cursor, triple input swap up**
- Swap vtm back **up->select**
- with the HM04, now in rival name **2 above Master Ball x5**
